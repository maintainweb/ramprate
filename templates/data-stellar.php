 <?php if( get_field('parallax') ) {
  $data_stellar_background_ratio = get_field('data_stellar_background_ratio');
  $data_stellar_horizontal_offset = get_field('data_stellar_horizontal_offset');
  $data_stellar_vertical_offset = get_field('data_stellar_vertical_offset');
  ?>
